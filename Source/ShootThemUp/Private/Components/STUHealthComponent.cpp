    ...
    AActor* DamagedActor, float Damage, const UDamageType* DamageType, AController* InstigatedBy, AActor* DamageCauser)
{
    ...
    bool DoAttack = USTUPlayerHUDWidget::AreEnemies(InstigatedBy, ComponentOwnerPawn->GetController()) || !InstigatedBy; // If InstigatedBy is nullptr this is DamageActor
